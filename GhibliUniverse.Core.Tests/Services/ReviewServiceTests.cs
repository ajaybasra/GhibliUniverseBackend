...
public class ReviewServiceTests
{
    ...
    public async Task CreateFilm_PersistsNewlyCreatedReview_WhenCalled()
    {
        _mockedReviewRepository
            .Setup(x => x.CreateReview(Guid.Empty, new Review() {Rating = Rating.From(10)}))
        ...
        await _reviewService.CreateReview(Guid.Empty, new Review() {Rating = Rating.From(10)});
    ...
    public async Task UpdateReview_UpdatesReviewRating_WhenCalled()
    {
        ...
        _mockedReviewRepository.Setup(x => x.UpdateReview(reviewId, new Review() {Rating = Rating.From(10)})).Callback((Guid id, int rating) =>
        {
