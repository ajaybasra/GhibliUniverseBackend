...
public class FilmControllerTests
{
    ...
    public async Task GetFilmByIdEndpoint_ReturnsFilmResponseDTOAnd200StatusCode_WhenGivenValidId()
    {
        ...
        var response = await _client.GetAsync("api/Film/00000000-0000-0000-0000-000000000001");
        var result = await response.Content.ReadAsStringAsync();
    ...
    {
        var response = await _client.GetAsync("api/Film/00000040-0000-5000-0000-000000000001");
    ...
    public async Task GetVoiceActorsByFilmEndpoint_ReturnsListOfVoiceActorResponseDTOAnd200StatusCode_WhenGivenValidId()
    {
        ...
        var response = await _client.GetAsync($"api/Film/00000000-0000-0000-0000-000000000001/voiceActors");
        var result = await response.Content.ReadAsStringAsync();
    ...
    {
        var response = await _client.GetAsync($"api/Film/00005000-0000-0000-0000-000000000001/voiceActors");
    ...
    public async Task CreateFilmEndpoint_ReturnsFilmResponseDTOAnd200StatusCode_WhenGivenValidInput()
    {
        ...
        var response = await _client.PostAsync("/api/Film",
    ...
    [Fact]
    public async Task CreateFilmEndpoint_Returns400StatusCode_WhenGivenInvalidInput()
    {
    ...
    public async Task LinkVoiceActorEndpoint_Returns200StatusCode_WhenGivenValidId()
    {
        ...
        var response = await _client.PostAsync($"/api/Film/00000000-0000-0000-0000-000000000001/LinkVoiceActor",
        ...
        var responseTwo = await _client.GetAsync($"api/Film/00000000-0000-0000-0000-000000000001/voiceActors");
    ...
    public async Task UnlinkVoiceActorEndpoint_Returns200StatusCode_WhenGivenValidId()
    {
        ...
        var response = await _client.PostAsync($"/api/Film/00000000-0000-0000-0000-000000000001/UnlinkVoiceActor", new StringContent(voiceActorIdAsJson, Encoding.UTF8, "application/json"));
    ...
    public async Task UpdateFilmEndpoint_ReturnsFilmResponseDTOAnd200StatusCode_WhenGivenValidInput()
    {
        ...
        var response = await _client.PutAsync($"/api/Film/00000000-0000-0000-0000-000000000001", new StringContent(filmRequestDtoAsJson, Encoding.UTF8, "application/json"));
        var films = await context.Films
            .Select(film => film).ToListAsync();
        var filmResponseDTO = _mapper.Map<FilmResponseDTO>(films[1]);
        var expectedResult = JsonConvert.SerializeObject(filmResponseDTO,
            new JsonSerializerSettings() { ContractResolver = new CamelCasePropertyNamesContractResolver() });
    ...
    public async Task DeleteFilmEndpoint_Returns200StatusCode_WhenGivenValidId()
    {
        ...
        var response = await _client.DeleteAsync($"api/Film/00000000-0000-0000-0000-000000000001");
        var actualHttpStatusCode = response.StatusCode;
        var films = await context.Films.Select(film => film).ToListAsync();
